...
function write(app) {
  ...
  console.log('export STORMPATH_API_KEY_ID=' + api_key_id);
  console.log('export STORMPATH_API_KEY_SECRET=' + api_key_secret);
  console.log('export STORMPATH_APP_HREF=' + app.href);
  console.log('export EXPRESS_SECRET=' + secret);
